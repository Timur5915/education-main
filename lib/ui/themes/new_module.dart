...
class NewModuleScreen extends StatefulWidget {
  final bool isAdmin;
  NewModuleScreen({this.isAdmin});
  @override
  _NewModuleScreenState createState() => _NewModuleScreenState();
}
...
class _NewModuleScreenState extends State<NewModuleScreen> {
  ...
  void createRecord(String name, int index) {
    databaseReference.child("modules/$index").set({
      'name': '$name',
      'id': '$index',
    });
  }
        ...
        appBar: AppBar(
          leading: IconButton(
            ...
            onPressed: () => Navigator.pushReplacement(context,
                MaterialPageRoute(builder: (builder) => ModuleListScreen())),
          ),
